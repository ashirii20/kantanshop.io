    ...
    <section class = "product-area">
      ...
      <div class = "search-filter-bar">
        ...
        <div class = "add-to-cart-button">
          <form method = "POST" action = "addtocart.php" style = "display: inline; margin-left: 10px;">
            <input type = "hidden" name = "product_name" value = "<?php echo htmlspecialchars($product['name']); ?>">
            <input type = "hidden" name = "price" value = "<?php echo $product['price']; ?>">
            <input type = "hidden" name = "quantity" value = "1">
            <input type = "hidden" name = "action" value = "add">
            <button type = "submit" class = "addtocart-btn">
              <img src = "cart.png" alt = "Add to Cart" class = "cart-icon">
            </button>
          </form>
        ...
        <div class = "wishlist-button">
          <form action = "wishlist.php" method = "POST" style = "display:inline;">
            <input type = "hidden" name = "add" value = "<?php echo htmlspecialchars($product['name']); ?>">
            <input type = "hidden" name = "product" value = "<?php echo htmlspecialchars($product['name']); ?>">
            <button type = "submit" class = "wishlist-btn">
              <img src = "heart.png" class = "wishlist-icon" alt = "Wishlist">
            </button>
          </form>
        </div>
      </div>
          ...
          <div class = "product-card" style = "background-color: #d9d6d6;">
            ...
            <div class = "product-actions">
                ...
                <form action = "wishlist.php" method = "POST" style = "display:inline;">
                    ...
                    <input type = "hidden" name = "product" value = "<?= htmlspecialchars($product['name']) ?>">
                    <input type = "hidden" name = "remove" value = "<?php echo htmlspecialchars($product['name']); ?>">
                    <button type = "submit" class = "icon-btn">
